...
public class MinTest { 
	...
	public void testEmptyList() { Min.min (list); } 
	...
	@Test public void testDoubleElement() { 
		list.add ("dog"); 
		list.add ("cat"); 
		Object obj = Min.min (list); 
	...
	@Test public void testDoubleIntElement() { 
		list.add (1); 
		list.add (2); 
		Object obj = Min.min (list); 
		assertTrue ("Double Element List", obj.equals (1));
		} 
